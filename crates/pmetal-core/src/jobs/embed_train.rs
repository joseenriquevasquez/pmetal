...
pub struct EmbedTrainSpec {
    ...
    #[job(label = "Output Dir", group = "Output", argv = "--output", kind = "path", default = "./output-embed")]
    ...
    #[job(label = "Temperature", group = "Loss", argv = "--temperature", min = 0.001, max = 10.0, default_float = 0.05)]
    #[serde(default = "default_temperature")]
    pub temperature: f32,

    #[job(label = "Margin", group = "Loss", argv = "--margin", min = 0.0, max = 10.0, default_float = 0.3)]
    ...
    #[job(label = "Batch Size", group = "Training", argv = "--batch-size", min = 1, max = 4096, default_int = 32)]
    #[serde(default = "default_batch_size")]
    pub batch_size: usize,

    #[job(label = "Epochs", group = "Training", argv = "--epochs", min = 1, max = 1000, default_int = 3)]
    ...
    #[job(label = "Weight Decay", group = "Optimization", argv = "--weight-decay", min = 0.0, max = 1.0, default_float = 0.01)]
    #[serde(default = "default_weight_decay")]
    pub weight_decay: f64,

    #[job(label = "Disable L2 Norm", group = "Loss", argv = "--no-normalize", flag, default_bool = false)]
    #[serde(default)]
    pub no_normalize: bool,

    #[job(label = "Log Every", group = "Output", argv = "--log-every", min = 1, max = 65536, default_int = 10)]
