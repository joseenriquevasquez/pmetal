...
pub struct TokenizeSpec {
    #[job(label = "Input JSONL", group = "Input", argv = "--input", kind = "path", required)]
    #[serde(default)]
    pub input: String,
    ...
    #[job(label = "Tokenizer Model", group = "Tokenizer", argv = "--tokenizer", kind = "model_picker", required)]
    #[serde(default)]
    pub tokenizer: String,

    #[job(label = "Text Column", group = "Input", argv = "--text-column", default = "text")]
    #[serde(default = "default_text_column")]
    pub text_column: String,

    #[job(label = "Docs Per Shard", group = "Output", argv = "--docs-per-shard", min = 1, max = 1_000_000, default_int = 10000)]
