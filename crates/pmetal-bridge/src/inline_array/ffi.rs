...
unsafe extern "C" {
    ...
    pub(super) fn mlx_inline_compiled_gptoss_attn_layer_fixed(
        dst_out: *mut RawBuf,
        dst_cache_keys: *mut RawBuf,
        dst_cache_vals: *mut RawBuf,
        normed: *const RawBuf,
    ...
    pub(super) fn mlx_inline_turboquant_mixed_score(
        ...
        regular_slot_scale: *const RawBuf,
        ...
        outlier_slot_scale: *const RawBuf,
    ...
    pub(super) fn mlx_inline_turboquant_attention_q8_d128_no_qjl_2pass(
        out: *mut RawBuf,
        query_rot: *const RawBuf,
        key_indices: *const RawBuf,
        key_norms: *const RawBuf,
    ...
    pub(super) fn mlx_inline_turboquant_attention_q8_d128_no_qjl_2pass_with_outlier_bias(
        out: *mut RawBuf,
        query_rot: *const RawBuf,
        key_indices: *const RawBuf,
        key_norms: *const RawBuf,
    ...
    pub(super) fn mlx_inline_turboquant_attention_q8_d256_no_qjl_2pass_with_outlier_bias(
        out: *mut RawBuf,
        query_rot: *const RawBuf,
        key_indices: *const RawBuf,
        key_norms: *const RawBuf,
